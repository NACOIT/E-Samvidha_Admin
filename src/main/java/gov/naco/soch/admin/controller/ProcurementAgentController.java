...
@RestController
@RequestMapping("/procurementAgent")
public class ProcurementAgentController {
	private static final Logger logger = LoggerFactory.getLogger(ProcurementAgentController.class);

	@Autowired
	private FacilityService facilityService;

	public ProcurementAgentController() {
	}
	...
	public @ResponseBody List<SacsFacilityDto> getAllProcurementAgentList(
		...
		facilityTypeId.add(FacilityTypeEnum.PROCUREMENT_AGENT.getFacilityType()); // SACS facility Type Id
	...
	@PreAuthorize("hasAuthority('" + AdminAccessCodes.NACO_ADMIN_SUPPLIERS + "') or hasAuthority('"
			+ AdminAccessCodes.PROCUREMENT_STAFF_SUPPLIERS + "')")
	public @ResponseBody SacsFacilityDto addProcurementAgent(@Valid @RequestBody SacsFacilityDto sacsFacilityDto) {
	...
	public SacsFacilityDto deleteProcurementAgent(@PathVariable("facilityId") Long facilityId) {
	...
	public @ResponseBody List<SacsFacilityDto> advanceSearchForFacilities(
		...
		facilityTypeIds.add(FacilityTypeEnum.PROCUREMENT_AGENT.getFacilityType());
