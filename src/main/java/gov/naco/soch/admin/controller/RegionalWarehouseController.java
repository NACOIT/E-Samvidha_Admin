...
public class RegionalWarehouseController {
	...
	@PreAuthorize("hasAuthority('" + AdminAccessCodes.NACO_ADMIN_SUPPLIERS + "') or hasAuthority('"
			...
			+ AdminAccessCodes.SACS_ADMIN_REGIONALWAREHOUSES + "')")
	...
	public @ResponseBody SacsFacilityDto addRegionalWarehouse(@Valid @RequestBody SacsFacilityDto sacsFacilityDto) {
